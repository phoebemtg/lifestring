...
const JoinsList: React.FC<JoinsListProps> = ({ className = "" }) => {
  ...
  const sampleJoins: Join[] = [
    {
      id: '1',
      title: 'Bay Area Aviation Enthusiasts',
      description: 'A community for aviation lovers in the San Francisco Bay Area. Whether you\'re a pilot, aviation student, or just fascinated by aircraft, join us to share experiences, discuss aviation topics, and connect with fellow aviation enthusiasts.',
      location: 'San Francisco Bay Area, CA',
      duration: 'Ongoing',
      max_participants: 75,
      current_participants: 34,
      difficulty: 'all_levels',
      tags: ['aviation', 'flying', 'pilots', 'aircraft', 'airports', 'air shows', 'bay area', 'community'],
      is_joined: false,
      match_score: 95,
    ...
    {
      id: '2',
      title: 'Silicon Valley Tech Professionals',
      description: 'Connect with fellow tech professionals in Silicon Valley and beyond. Share insights about the latest technologies, discuss career opportunities, collaborate on side projects, and network with like-minded individuals.',
      location: 'Silicon Valley, CA',
      duration: 'Ongoing',
      max_participants: 200,
      current_participants: 127,
      difficulty: 'all_levels',
      tags: ['tech', 'technology', 'silicon valley', 'programming', 'startups', 'networking', 'career', 'software'],
      is_joined: false,
      match_score: 93,
    ...
    {
      id: '3',
      title: 'SF Business Network & Entrepreneurs',
      description: 'A dynamic community for business professionals, entrepreneurs, and aspiring business leaders in San Francisco. Share business insights, discuss market trends, find potential collaborators, and grow your professional network.',
      location: 'San Francisco, CA',
      duration: 'Ongoing',
      max_participants: 150,
      current_participants: 89,
      difficulty: 'all_levels',
      tags: ['business', 'entrepreneurship', 'networking', 'startups', 'san francisco', 'professional', 'career', 'finance'],
      is_joined: false,
      match_score: 91,
    ...
    {
      id: '4',
      title: 'California Travel Adventurers',
      description: 'Join fellow travel enthusiasts exploring California and beyond! Share travel tips, plan group trips, discover hidden gems, and connect with people who love to explore new places. From weekend getaways to international adventures, all travel styles welcome.',
      location: 'California',
      duration: 'Ongoing',
      max_participants: 100,
      current_participants: 56,
      difficulty: 'all_levels',
      tags: ['travel', 'adventure', 'california', 'exploration', 'trips', 'wanderlust', 'destinations', 'culture'],
      is_joined: false,
      match_score: 89,
      created_at: '2024-11-13T07:00:00Z'
    },
    {
      id: '5',
