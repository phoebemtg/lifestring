-- Fix RLS policies for strings table and create missing tables
-- Run this in Supabase SQL Editor

-- First, drop any conflicting policies on strings table
...
DROP TRIGGER IF EXISTS update_house_competitions_updated_at ON public.house_competitions;
