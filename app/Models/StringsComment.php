...
class StringsComment extends Model
{
    ...
    {
        return $this->belongsTo(StringsComment::class, 'parent_comment_id');
    }
    ...
    {
        return $this->hasMany(StringsComment::class, 'parent_comment_id');
    }
