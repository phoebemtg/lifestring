...
use App\Models\StringComment;
use App\Models\User;
use Illuminate\Auth\Access\HandlesAuthorization;

class StringCommentPolicy
{
     ...
     */
    public function update(User $user, StringComment $comment): bool
    {
     ...
     */
    public function delete(User $user, StringComment $comment): bool
    {
