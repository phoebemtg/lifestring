-- Simple sample Connected Strings for testing
-- Run this SQL directly in Supabase SQL editor
-- This creates just the events without worrying about user constraints
...
VALUES 
  ...
  (
    ...
    'Perfect for beginners! Join me for a relaxing morning walk through Golden Gate Park trails. We will explore the quieter paths and enjoy some fresh air. Great for meeting new people and getting some light exercise. Contact Mike Chen at mike.c@example.com',
    '2025-10-29 09:00:00+00',
    '2025-10-29 11:00:00+00',
    'Golden Gate Park, San Francisco, CA',
    '{"is_join": "true", "type": "hiking", "difficulty": "easy", "max_participants": 6, "cost": "Free", "tags": "hiking, easy, morning, golden gate park, beginner friendly", "creator_profile": {"name": "Mike Chen", "email": "mike.c@example.com", "bio": "Weekend warrior who loves outdoor adventures and meeting new people!"}}',
    '{}',
    NOW()
  ),
  (
  ...
  (
    ...
    'Calling all photography enthusiasts! Join me for a scenic hike through Muir Woods with plenty of stops for capturing the majestic redwoods. Bring your camera and let''s create some beautiful memories together. Contact Jessica Park at jessica.p@example.com',
    '2025-11-03 08:30:00+00',
    '2025-11-03 13:30:00+00',
    'Muir Woods National Monument, CA',
    '{"is_join": "true", "type": "hiking", "difficulty": "intermediate", "max_participants": 6, "cost": "Park entrance fee (~$15)", "tags": "hiking, photography, muir woods, redwoods, nature, scenic", "creator_profile": {"name": "Jessica Park", "email": "jessica.p@example.com", "bio": "Travel blogger and outdoor enthusiast. Love documenting beautiful hikes!"}}',
    '{}',
    NOW()
  );
